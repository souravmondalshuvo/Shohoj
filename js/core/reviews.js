...
const SEEDED_REVIEWS = [
  {
    ...
    text: 'Honestly one of the calmest CSE250 classes I had. She breaks circuit topics down slowly, and asking a basic question never feels embarrassing in her section.',
    createdAt: 1768737600000,
    seeded: true,
  },
  {
    ...
    text: 'Her notes were actually useful, which is rare. Before quizzes I mostly revised from those and the class examples, and that covered most of what I needed.',
  ...
  },
  {
    ...
    semester: 'Spring 2026',
    ratings: { teaching: 5, marking: 5, behavior: 5, difficulty: 2, workload: 3 },
    text: 'Marking felt fair to generous. If your steps made sense, she usually gave decent partial marks even when the final answer was not fully correct.',
    createdAt: 1770120000000,
    seeded: true,
  },
  {
    ...
    text: 'The quizzes were manageable if you actually practiced the tutorial problems. She was also pretty responsive when people needed a quick clarification before class tests.',
  ...
  },
  {
    ...
    text: 'Very kind overall. A lot of people in our section felt lucky to get her for CSE250 because she teaches well without making the class stressful.',
    createdAt: 1771588800000,
    seeded: true,
  },
  {
    ...
    semester: 'Spring 2026',
    ratings: { teaching: 5, marking: 5, behavior: 5, difficulty: 2, workload: 3 },
    text: 'If you are new to coding, his class is easy to follow. He repeats the important logic and uses simple examples before moving to harder problems.',
    createdAt: 1770120000000,
    seeded: true,
  },
  {
    ...
    semester: 'Spring 2026',
    ratings: { teaching: 5, marking: 5, behavior: 5, difficulty: 2, workload: 3 },
    text: 'His marking is definitely on the generous side. Even when my output was not perfect, I still got marks because the logic and steps were mostly right.',
    createdAt: 1770897600000,
    seeded: true,
  },
  {
    ...
    semester: 'Spring 2026',
    ratings: { teaching: 5, marking: 5, behavior: 5, difficulty: 2, workload: 3 },
    text: 'During consultation he is easy to talk to and does not make you feel dumb for asking a very basic thing. That helped a lot in CSE110.',
    createdAt: 1771588800000,
    seeded: true,
  },
  {
    ...
    text: 'One small warning: if your code is written in an unusual way, recheck everything before a lab or show-up. A few people felt unconventional solutions were graded a bit quickly.',
    createdAt: 1772280000000,
    seeded: true,
  },
  {
    ...
    semester: 'Spring 2026',
    ratings: { teaching: 5, marking: 5, behavior: 5, difficulty: 2, workload: 3 },
    text: 'For quizzes, his class examples and practice sheets matter a lot. People who actually solved those regularly usually did fine in the course.',
    createdAt: 1773230400000,
    seeded: true,
  },
  {
    ...
    semester: 'Spring 2026',
    ratings: { teaching: 5, marking: 5, behavior: 5, difficulty: 2, workload: 3 },
    text: 'Best way to do well in his section is to follow the way he teaches the logic and use consultation when you get stuck. That combination worked for a lot of students.',
    createdAt: 1774353600000,
    seeded: true,
  },
];
