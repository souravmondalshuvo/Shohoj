    ...
    return (
        <section className="shell-page bus-page" data-testid="bus-page">
            ...
            <p className="shell-muted">
                BRAC University students&apos; transport — air-conditioned buses on
                every route, fares payable through bKash.
            </p>
            ...
            <div className="bus-effective" data-testid="bus-effective" role="note">
                ...
                {BUS_SERVICE_AVAILABILITY} The Transport Office may change any route,
                stoppage, schedule or fare at any time — when in doubt, confirm with
                the contacts below.
            </div>
                    ...
                    <button
                        ...
                        className={
                            route.id === selected.id
                                ? 'bus-route-btn bus-route-btn--active'
                                : 'bus-route-btn'
                        }
            ...
            <div className="bus-detail" data-testid="bus-detail">
                <div className="bus-detail-head">
                    ...
                    <span className="bus-fare" data-testid="bus-fare">{fareLine(selected)}</span>
                </div>
                        ...
                        <tbody>
                            {selected.inbound.map((stop) => (
                                <tr
                                    key={stop.name}
                                    className={
                                        stop.name === nextPickup?.stop ? 'bus-stop--next' : undefined
                                    }
                                >
