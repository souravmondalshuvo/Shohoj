...
const stop = (name: string, firstTrip: string | null, secondTrip: string | null = null): BusStop =>
    ({ name, firstTrip, secondTrip });
...
export const BUS_ROUTES: readonly BusRouteVariant[] = [
    ...
    },
    {
        ...
        name: 'Abdullahpur-B',
        inbound: [
            stop('Jashimuddin (opposite to RAK Shopping Complex, Uttara Sector #01, Road #14)', '6:20 AM'),
            stop('Korotoa Courier Point (opposite to Korotoa Courier Service, Uttara Sector #03, Road #18)', '6:22 AM'),
            ...
            stop('Tagore University Point (in front of Tagore University of Creative Arts, Sector #12)', '6:29 AM'),
    ...
    },
    {
        ...
        name: 'Mirpur-B',
        inbound: [
            stop('Mirpur 14 Bus Stand (opposite to Marks Medical College Hospital)', '6:35 AM', '8:35 AM'),
            stop('In front of NAM Garden Officers Quarter, Mirpur 13 (near BRTA 2nd Gate)', '6:37 AM', '8:37 AM'),
    ...
    },
    {
        ...
        name: 'Jigatola-A',
        inbound: [
            stop('Jigatola Bus Stand (in front of Japan-Bangladesh Friendship Hospital)', '6:35 AM', '8:40 AM'),
    ...
    },
    {
        ...
        name: 'Mohammadpur-B',
        inbound: [
            stop("In front of Bata Showroom (opposite to Japan Garden City's main gate)", '6:35 AM', '8:30 AM'),
            stop('In front of Baitus Sujud Jame Mosque (near Mohammadpur Bus Stand/Nurjahan Road)', '6:40 AM', '8:36 AM'),
            ...
            stop('New Model Multilateral High School (opposite to Kalabagan bus counters)', '6:50 AM', '8:48 AM'),
