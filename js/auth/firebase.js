...
window._shohoj_submitReview = async function({ id, data }) {
  ...
  try {
    ...
    if (existing.exists()) {
      return {
        ok: false,
        error: 'You already submitted a review for this faculty-course pair. Reviews are locked after submission for safety.',
        code: 'review-exists',
      };
    }
    ...
    if (e.code === 'permission-denied') {
      return {
        ok: false,
        error: 'Review could not be submitted. Make sure the course is valid and that you have not already reviewed this faculty for it.',
        code: e.code,
      };
    }
