// Twin of src/core/semesterArchive.ts — hand-maintained, not generated.
// src/core/semesterArchive.ts is the source of truth: change it there first, then mirror the
...
/**
  ...
  */
export function normalizeArchiveListing(raw) {
    const body = raw;
...
export function archiveListUrl(workerUrl) {
...
export function archivePayloadUrl(workerUrl, sessionId) {
    const base = trimBase(workerUrl);
...
/**
  ...
  */
export function archiveCacheKey(sessionId) {
...
/**
  ...
  */
export function archiveGapNotice(entry) {
...
/**
  ...
  */
export async function fetchArchiveListing(options = {}) {
