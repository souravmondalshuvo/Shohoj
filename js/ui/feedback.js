...
function _renderModal() {
  ...
  content.innerHTML = `
    ...
    <div style="display:flex;background:${t.inputBg};border-radius:30px;padding:3px;margin-bottom:20px;position:relative;">
      ...
      <button id="fbTabSubmit" onclick="window._shohoj_fbTab('submit')" style="position:relative;z-index:1;flex:1;padding:7px 0;font-size:12px;font-weight:700;border:none;background:transparent;color:#fff;cursor:pointer;border-radius:27px;font-family:inherit;">Submit</button>
...
function _syncTypeButtons() {
  ...
  ['bug','feature','general'].forEach(v => {
    ...
    btn.style.color        = on ? '#fff'      : t.text2;
