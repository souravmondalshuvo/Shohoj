...
void main() {
	...
	`}var Ts=class extends Dn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ya(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function rd(e,t,n){let r;try{r=new lu({antialias:!0,alpha:!0})}catch{return null}let i=n.colors,a=new X(i.roomBusy),o=new fr,s=window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches??!1,c=t.floors.length?t.floors[t.floors.length-1].floor:Wu,l=new Map(t.floors.map(e=>[e.floor,e])),u=(c-Wu)*zu,d=$u(new Date().getHours());o.add(new Co(16777215,.35));let f=new oo(new X(d.sky),new X(d.horizon),.7);o.add(f);let p=new So(new X(d.sunColor),d.sunIntensity);p.position.set(40,70,25),p.castShadow=!0,p.shadow.mapSize.set(1024,1024),p.shadow.camera.left=-48,p.shadow.camera.right=48,p.shadow.camera.top=64,p.shadow.camera.bottom=-48,p.shadow.camera.near=1,p.shadow.camera.far=220,p.shadow.bias=-5e-4,o.add(p);let m=new Ta(Gu,56).rotateX(-Math.PI/2),h=new Ha({color:new X(`#f2f7f3`),roughness:1,metalness:0,transparent:!0,opacity:.55}),g=new Ji(m,h);g.position.y=-.7*1.6,g.receiveShadow=!0,o.add(g);let _=new Fu(Iu,Ru,Lu,2,.28),v=new ir;o.add(v);let y=new Map,b=[];for(let e=Wu;e<=c;e++){let t=l.has(e),n=new Ha({color:new X(t?i.slab:i.slabInactive),roughness:.8,metalness:.05,transparent:!0}),r=new Ji(_,n),a=(e-Wu)*zu;r.position.set(0,a,0),r.castShadow=!0,r.receiveShadow=!0,r.userData.floor=e,r.userData.interactive=t,v.add(r);let o=ed(e,t),s=new fi({map:o,transparent:!0,depthWrite:!1}),c=new Ei(s);c.scale.set(3,3,1),c.position.set(16.4,.2,16.4),r.add(c),b.push({floor:e,interactive:t,baseY:a,mesh:r,label:c,labelMaterial:s,labelTexture:o,targetY:a,targetOpacity:1,targetColor:n.color.clone()})}let x=new wa(32.4,u+zu*2,32.4),S=new Ha({color:new X(d.sky),transparent:!0,opacity:.1,roughness:.15,metalness:.25,depthWrite:!1}),C=new Ji(x,S);C.position.y=u/2,C.renderOrder=2,o.add(C);let w=new Ba({uniforms:{uColor:{value:new X(d.sunColor)},uPower:{value:2.4},uOpacity:{value:.5}},vertexShader:td,fragmentShader:nd,transparent:!0,blending:2,side:1,depthWrite:!1}),T=new Ji(x,w);T.position.copy(C.position),T.renderOrder=2,o.add(T);let E=new Aa(x),D=new oa({color:new X(`#7fa9c9`),transparent:!0,opacity:.35}),O=new va(E,D);O.position.copy(C.position),O.renderOrder=3,o.add(O);let k={tower:.1,focused:.03},A={tower:.35,focused:.1},ee={tower:.5,focused:.12},te=k.tower,j=A.tower,ne=ee.tower,re=new Fu(Vu,Hu,Vu,2,.18),M=new ir;o.add(M);let N=[],P=null,ie=new Map,ae=null,F=!1;function oe(e){if(e.code===ae)return i.highlight;let t=ie.get(e.code);return t===`free`?i.roomFree:t===`busy`?i.roomBusy:i.roomUnknown}function I(){for(let e of N)M.remove(e.mesh),e.mesh.material.dispose();N=[]}function L(e){I();let t=l.get(e),n=b.find(t=>t.floor===e);if(!t||!n)return;let r=t.zones.length;t.zones.forEach((e,t)=>{let i=t/r*Math.PI*2-Math.PI/2,a=Math.cos(i)*Uu,o=Math.sin(i)*Uu;e.rooms.forEach((t,r)=>{let i=r%2,c=Math.floor(r/2),l=new X(oe(t)),u=new Ha({color:l,roughness:.55,metalness:.05,emissive:l.clone(),emissiveIntensity:.12,transparent:!0}),d=new Ji(re,u);d.position.set(a+(i-.5)*2.2,n.targetY+Ru/2+Hu/2,o+(c-(e.rooms.length/2-.5)/2)*2.2),d.castShadow=!0,d.userData.roomCode=t.code,s||d.scale.setScalar(.001),M.add(d),N.push({room:t,mesh:d,spawnAt:performance.now(),stagger:Math.min(N.length*Ju,.5),phase:N.length*.7,pulsing:!1})})}),se()}function se(){for(let e of N){let t=oe(e.room),n=e.room.code===ae,r=ie.get(e.room.code),i=F&&r!==`free`&&!n;e.mesh.material.color.set(t),e.mesh.material.emissive.set(t),e.mesh.material.opacity=i?.12:1,e.mesh.material.emissiveIntensity=i?0:n?.55:F&&r===`free`?.4:.12,e.pulsing=!n&&!i&&r===`busy`}}function ce(e){if(P!==null&&e.floor===P)return new X(i.slabSelected);if(!e.interactive)return new X(i.slabInactive);let t=y.get(e.floor)??0;return new X(Qu(i.slab,`#${a.getHexString()}`,t))}function le(){for(let e of b)e.targetColor.copy(ce(e))}function ue(){for(let e of b){let t=P!==null&&e.floor>P;e.targetY=e.baseY+(t?Bu:0);let n=P!==null&&e.floor===P;e.targetOpacity=P===null||n?1:t?.18:.55,e.mesh.castShadow=e.targetOpacity>.5,e.targetColor.copy(ce(e))}let e=P!==null;te=e?k.focused:k.tower,j=e?A.focused:A.tower,ne=e?ee.focused:ee.tower,P===null?I():L(P),pe()}r.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),r.shadowMap.enabled=!0,r.shadowMap.type=2,r.domElement.setAttribute(`aria-hidden`,`true`),e.appendChild(r.domElement);let R=document.createElement(`div`);R.className=`campus-tooltip`,R.setAttribute(`data-testid`,`campus-tooltip`),R.setAttribute(`role`,`status`),R.hidden=!0;let de=document.createElement(`strong`);de.className=`campus-tooltip-title`;let fe=document.createElement(`span`);fe.className=`campus-tooltip-detail`,R.append(de,fe),e.appendChild(R);function pe(){R.hidden||(R.hidden=!0,r.domElement.style.cursor=``)}let me=new yo(45,1,.1,500);me.position.set(46,u*.9+18,46);let he=new bu(me,r.domElement);he.target.set(0,u/2,0),he.enableDamping=!s,he.maxPolarAngle=Math.PI*.52,he.minDistance=18,he.maxDistance=160,he.autoRotateSpeed=.5;let ge=performance.now(),_e=()=>{ge=performance.now()};he.addEventListener(`start`,_e);function ve(){let t=Math.max(e.clientWidth,1),n=Math.max(e.clientHeight,1);r.setSize(t,n,!1),me.aspect=t/n,me.updateProjectionMatrix()}ve();let ye=typeof ResizeObserver<`u`?new ResizeObserver(ve):null;ye?.observe(e);let be=performance.now();r.setAnimationLoop(e=>{let t=Math.min((e-be)/1e3,.1);be=e;let n=s?1:1-Math.exp(-t*Ku);for(let e of b)e.mesh.position.y+=(e.targetY-e.mesh.position.y)*n,e.mesh.material.opacity+=(e.targetOpacity-e.mesh.material.opacity)*n,e.mesh.material.color.lerp(e.targetColor,n),e.labelMaterial.opacity=e.mesh.material.opacity;S.opacity+=(te-S.opacity)*n,D.opacity+=(j-D.opacity)*n;let i=w.uniforms.uOpacity;if(i.value+=(ne-i.value)*n,!s)for(let t of N){let n=(e-t.spawnAt)/1e3-t.stagger,r=Zu(Math.min(Math.max(n/qu,0),1));t.mesh.scale.setScalar(Math.max(.001,r)),t.pulsing&&(t.mesh.material.emissiveIntensity=.1+.08*(.5+.5*Math.sin(e/420+t.phase)))}he.autoRotate=!s&&e-ge>Yu,he.update(),r.render(o,me)});let xe=new Vo,Se=new K,Ce=null;function we(e){let t=r.domElement.getBoundingClientRect();Se.set((e.clientX-t.left)/t.width*2-1,-((e.clientY-t.top)/t.height)*2+1),xe.setFromCamera(Se,me);let n=xe.intersectObjects(M.children,!1)[0]?.object.userData.roomCode;return typeof n==`string`?n:null}function Te(e){let t=we(e);if(t!==null){n.onRoomClick?.(t);return}let i=r.domElement.getBoundingClientRect();Se.set((e.clientX-i.left)/i.width*2-1,-((e.clientY-i.top)/i.height)*2+1),xe.setFromCamera(Se,me);let a=xe.intersectObjects(v.children,!1).find(e=>e.object.userData.interactive===!0)?.object.userData.floor;typeof a==`number`&&n.onFloorClick?.(a)}let Ee=e=>{Ce={x:e.clientX,y:e.clientY}},De=e=>{if(!Ce)return;let t=Math.hypot(e.clientX-Ce.x,e.clientY-Ce.y);Ce=null,t<6&&Te(e)},z=e=>{if(Ce||P===null||N.length===0){pe();return}let t=we(e),i=t===null?null:n.describeRoom?.(t)??null;if(!i){pe();return}de.textContent=i.title,fe.textContent=i.detail,R.dataset.status=i.status;let a=r.domElement.getBoundingClientRect();R.style.left=`${e.clientX-a.left}px`,R.style.top=`${e.clientY-a.top}px`,R.hidden=!1,r.domElement.style.cursor=`pointer`},Oe=()=>pe();return r.domElement.addEventListener(`pointerdown`,Ee),r.domElement.addEventListener(`pointerup`,De),r.domElement.addEventListener(`pointermove`,z),r.domElement.addEventListener(`pointerleave`,Oe),ue(),{setFloor(e){P=e!==null&&l.has(e)?e:null,_e(),ue()},setRoomStatus(e){ie=e;let t=new Map;for(let[e,n]of l){let r=0,i=0;for(let e of n.zones)for(let t of e.rooms){let e=ie.get(t.code);(e===`free`||e===`busy`)&&(r+=1,e===`busy`&&(i+=1))}t.set(e,r>0?i/r:0)}y=t,le(),se()},setHighlight(e){ae=e?e.trim().toUpperCase():null,_e(),se()},setOnlyFree(e){F=e,se()},dispose(){r.setAnimationLoop(null),ye?.disconnect(),r.domElement.removeEventListener(`pointerdown`,Ee),r.domElement.removeEventListener(`pointerup`,De),r.domElement.removeEventListener(`pointermove`,z),r.domElement.removeEventListener(`pointerleave`,Oe),he.dispose(),I();for(let e of b)e.mesh.material.dispose(),e.labelMaterial.dispose(),e.labelTexture.dispose();_.dispose(),re.dispose(),m.dispose(),h.dispose(),x.dispose(),S.dispose(),w.dispose(),E.dispose(),D.dispose(),R.remove(),r.dispose(),r.domElement.remove()}}}var $=o(),id=[`SUNDAY`,`MONDAY`,`TUESDAY`,`WEDNESDAY`,`THURSDAY`,`FRIDAY`,`SATURDAY`],ad=`shohoj_campus_floor_v1`,od={slab:`#a9cdb8`,slabInactive:`#d8ded9`,slabSelected:`#5ecb8b`,roomFree:`#27ae60`,roomBusy:`#e74c3c`,roomUnknown:`#9aa59e`,highlight:`#2d5a8a`};function sd(){let e=new Date;return{day:id[e.getDay()],minute:e.getHours()*60+e.getMinutes()}}function cd(e){let t=Math.floor(e/60),n=e%60,r=t>=12?`PM`:`AM`;return`${t%12==0?12:t%12}:${String(n).padStart(2,`0`)} ${r}`}function ld(e){return e.charAt(0)+e.slice(1).toLowerCase()}function ud(){try{let e=localStorage.getItem(ad),t=e===null?NaN:parseInt(e,10);return Number.isFinite(t)?t:null}catch{return null}}function dd(e){try{e===null?localStorage.removeItem(ad):localStorage.setItem(ad,String(e))}catch{}}var fd={live:`Live`,cache:`Cached`,fallback:`Offline copy`};function pd(){let[e,t]=(0,m.useState)(null),[r,i]=(0,m.useState)(null),[a,o]=(0,m.useState)(sd),[h,g]=(0,m.useState)(ud),[_,v]=(0,m.useState)(null),[y,b]=(0,m.useState)({phase:`idle`}),[x,S]=(0,m.useState)(!0),[C,w]=(0,m.useState)(``),[T,E]=(0,m.useState)(!1),[D,O]=(0,m.useState)(!1),[A,ee]=n(),M=(0,m.useRef)(!1),N=(0,m.useRef)(null),P=(0,m.useRef)(null),ie=(0,m.useRef)(()=>null),ae=(0,m.useCallback)(e=>{let n=!0;return i(null),e&&O(!0),k({forceRefresh:e}).then(e=>{if(!n)return;let r=te(e.sections);t({index:r,model:d(ne(r)),source:e.source,fetchedAt:e.fetchedAt}),o(sd())}).catch(()=>{n&&i(`Could not load the class schedule feed.`)}).finally(()=>{n&&O(!1)}),()=>{n=!1}},[]);(0,m.useEffect)(()=>ae(!1),[ae]),(0,m.useEffect)(()=>{let e=setInterval(()=>o(sd()),6e4);return()=>clearInterval(e)},[]);let F=e?.model??null,oe=(0,m.useMemo)(()=>{let t=new Map;if(e)for(let n of e.index.keys()){let e=u(n);e&&t.set(e.code,n)}return t},[e]),I=(0,m.useMemo)(()=>{let t=new Map;if(e)for(let[n,r]of oe)t.set(n,re(e.index,r,a.day,a.minute)?`busy`:`free`);return t},[e,oe,a]),L=(0,m.useMemo)(()=>{let e=0,t=0;for(let n of I.values())n===`free`?e+=1:n===`busy`&&(t+=1);return{free:e,busy:t}},[I]);(0,m.useEffect)(()=>{if(!F||M.current)return;M.current=!0;let e=u(A.get(`room`));if(e&&F.roomsByCode.has(e.code)){g(e.floor),v(e.code);return}let t=Number(A.get(`floor`));Number.isInteger(t)&&F.floors.some(e=>e.floor===t)&&g(t)},[F,A]);let se=(0,m.useCallback)(e=>{g(e),dd(e),v(t=>t!==null&&e!==null&&u(t)?.floor===e?t:null)},[]),ce=(0,m.useCallback)(e=>{let t=u(e);t&&(g(t.floor),dd(t.floor),v(t.code))},[]),le=(0,m.useCallback)(()=>{if(!F)return;let e=C.trim().toUpperCase();if(!e)return;let t=u(e);if(t&&F.roomsByCode.has(t.code)){ce(t.code);return}let n=[...F.roomsByCode.keys()].filter(t=>t.startsWith(e));n.length===1&&ce(n[0])},[F,C,ce]);(0,m.useEffect)(()=>{M.current&&(_??null)!==(A.get(`room`)??null)&&ee(_?{room:_}:{},{replace:!0})},[_,A,ee]),ie.current=(0,m.useCallback)(t=>{let n=F?.roomsByCode.get(t);if(!n)return null;let r=I.get(t)??`unknown`,i=oe.get(t),o;if(e&&i){let t=re(e.index,i,a.day,a.minute);if(t)o=`In class · ${t.courseCode} until ${cd(t.endMin)}`;else{let t=j(e.index,i,a.day).find(e=>e.startMin>a.minute);o=t?`Free until ${cd(t.startMin)} · then ${t.courseCode}`:`Free for the rest of today`}}else o=`No classes scheduled here`;return{title:`${n.code} · ${f(n.kind)}`,status:r,detail:o}},[F,e,oe,a,I]),(0,m.useEffect)(()=>{let e=N.current;if(!F||!e)return;let t=rd(e,F,{colors:od,onFloorClick:e=>se(e),onRoomClick:e=>ce(e),describeRoom:e=>ie.current(e)});if(!t){S(!1);return}return S(!0),P.current=t,()=>{P.current=null,t.dispose()}},[F,se,ce]),(0,m.useEffect)(()=>{P.current?.setFloor(h)},[h,F]),(0,m.useEffect)(()=>{P.current?.setRoomStatus(I)},[I]),(0,m.useEffect)(()=>{P.current?.setHighlight(_)},[_]),(0,m.useEffect)(()=>{P.current?.setOnlyFree(T)},[T,F]);let ue=(0,m.useCallback)(()=>{if(!(`geolocation`in navigator)){b({phase:`error`,message:`Location is not available in this browser.`});return}b({phase:`checking`}),navigator.geolocation.getCurrentPosition(e=>{let t=c(e.coords.latitude,e.coords.longitude,p,l);b({phase:`done`,distance:t})},e=>{b({phase:`error`,message:e.code===e.PERMISSION_DENIED?`Location permission was denied.`:`Could not get a location fix.`})},{enableHighAccuracy:!0,timeout:1e4,maximumAge:6e4})},[]),R=_&&F?F.roomsByCode.get(_)??null:null,de=_?oe.get(_)??null:null,fe=e&&de?j(e.index,de,a.day):[],pe=e&&de?re(e.index,de,a.day,a.minute):null,me=fe.find(e=>e.startMin>a.minute)??null,he=F&&h!==null?F.floors.find(e=>e.floor===h)??null:null,ge=(0,m.useMemo)(()=>{if(!he)return[];let e=C.trim().toUpperCase();return he.zones.map(t=>({zone:t.zone,rooms:t.rooms.filter(t=>!(T&&I.get(t.code)!==`free`||e&&!t.code.includes(e)))})).filter(e=>e.rooms.length>0)},[he,C,T,I]);return(0,$.jsxs)(`section`,{className:`shell-page campus-page`,"data-testid":`campus-page`,children:[(0,$.jsx)(`h1`,{children:`Campus Map`}),(0,$.jsx)(`p`,{className:`shell-muted`,children:`The Merul Badda tower, drawn live from the class schedule feed — pick a floor to see its rooms and what's free right now.`}),r===null?!e||!F?(0,$.jsx)(`p`,{role:`status`,children:`Loading the schedule feed…`}):(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`campus-meta`,children:[(0,$.jsxs)(`span`,{className:`campus-meta-item`,children:[fd[e.source],` feed · as of `,cd(a.minute),` `,ld(a.day)]}),(0,$.jsxs)(`button`,{type:`button`,className:`shell-btn campus-meta-btn`,onClick:()=>ae(!0),children:[(0,$.jsxs)(`svg`,{width:`13`,height:`13`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.4`,strokeLinecap:`round`,strokeLinejoin:`round`,"aria-hidden":`true`,style:{marginRight:6},children:[(0,$.jsx)(`path`,{d:`M21 12a9 9 0 1 1-2.64-6.36`}),(0,$.jsx)(`path`,{d:`M21 3v6h-6`})]}),`Refresh`]}),(0,$.jsx)(`button`,{type:`button`,className:`shell-btn campus-meta-btn`,onClick:ue,disabled:y.phase===`checking`,children:y.phase===`checking`?`Checking…`:`Am I on campus?`}),(0,$.jsx)(`span`,{className:`campus-location`,"data-testid":`campus-location`,role:`status`,children:y.phase===`done`?s(y.distance)===`on-campus`?`On campus (~${Math.round(y.distance)} m from center)`:`Off campus (${(y.distance/1e3).toFixed(1)} km away)`:y.phase===`error`?y.message:``})]}),(0,$.jsxs)(`div`,{className:`campus-floors`,role:`group`,"aria-label":`Floor`,children:[(0,$.jsx)(`button`,{type:`button`,className:h===null?`campus-floor-btn campus-floor-btn--active`:`campus-floor-btn`,"aria-pressed":h===null,onClick:()=>se(null),children:`Tower`}),F.floors.map(e=>(0,$.jsxs)(`button`,{type:`button`,className:h===e.floor?`campus-floor-btn campus-floor-btn--active`:`campus-floor-btn`,"aria-pressed":h===e.floor,onClick:()=>se(e.floor),children:[`Floor `,e.floor]},e.floor))]}),(0,$.jsxs)(`form`,{className:`campus-controls`,role:`search`,"aria-label":`Find a room`,onSubmit:e=>{e.preventDefault(),le()},children:[(0,$.jsxs)(`label`,{className:`campus-search-field`,children:[(0,$.jsx)(`span`,{className:`shell-muted`,children:`Room`}),(0,$.jsx)(`input`,{type:`search`,className:`campus-search-input`,"data-testid":`campus-search-input`,placeholder:`e.g. 07A-01C`,value:C,onChange:e=>w(e.target.value),autoComplete:`off`,autoCapitalize:`characters`})]}),(0,$.jsx)(`button`,{type:`submit`,className:`shell-btn campus-meta-btn`,"data-testid":`campus-search-btn`,children:`Find`}),(0,$.jsxs)(`label`,{className:`campus-freefilter`,children:[(0,$.jsx)(`input`,{type:`checkbox`,"data-testid":`campus-onlyfree`,checked:T,onChange:e=>E(e.target.checked)}),`Only free rooms`]})]}),x?(0,$.jsx)(`div`,{className:`campus-canvas`,ref:N,"aria-hidden":`true`,"data-refreshing":D?`true`:void 0,"data-testid":`campus-canvas`}):(0,$.jsx)(`p`,{className:`shell-muted`,"data-testid":`campus-no-webgl`,children:`3D view isn't available on this device — the floor lists below show everything the map does.`}),D&&(0,$.jsx)(`p`,{className:`campus-room-sr`,"data-testid":`campus-refreshing`,role:`status`,children:`Refreshing the schedule feed…`}),(0,$.jsxs)(`div`,{className:`campus-legend`,"data-testid":`campus-legend`,role:`status`,"aria-live":`polite`,children:[(0,$.jsxs)(`span`,{className:`campus-legend-key`,children:[(0,$.jsx)(`i`,{className:`campus-dot campus-dot--free`}),(0,$.jsx)(`span`,{className:`campus-legend-count`,"data-testid":`campus-free-count`,children:L.free},L.free),` `,`free now`]}),(0,$.jsxs)(`span`,{className:`campus-legend-key`,children:[(0,$.jsx)(`i`,{className:`campus-dot campus-dot--busy`}),(0,$.jsx)(`span`,{className:`campus-legend-count`,"data-testid":`campus-busy-count`,children:L.busy},L.busy),` `,`in class`]}),(0,$.jsxs)(`span`,{className:`campus-legend-key`,"aria-hidden":`true`,children:[(0,$.jsx)(`i`,{className:`campus-dot campus-dot--selected`}),` Selected`]})]}),R&&(0,$.jsxs)(`div`,{className:`campus-room-panel`,"data-testid":`campus-room-panel`,children:[(0,$.jsxs)(`div`,{className:`campus-room-head`,children:[(0,$.jsx)(`strong`,{children:R.code}),(0,$.jsxs)(`span`,{className:`shell-muted`,children:[f(R.kind),` · Floor `,R.floor,` · Zone`,` `,R.zone]})]}),(0,$.jsx)(`p`,{className:`campus-room-status`,children:pe?`In class now — ${pe.courseCode} until ${cd(pe.endMin)}`:me?`Free until ${cd(me.startMin)} (then ${me.courseCode})`:`Free for the rest of today`}),fe.length>0&&(0,$.jsx)(`ul`,{className:`campus-room-schedule`,children:fe.map(e=>(0,$.jsxs)(`li`,{children:[cd(e.startMin),`–`,cd(e.endMin),` · `,e.courseCode,` (`,e.kind,`)`]},`${e.startMin}-${e.courseCode}-${e.sectionName}`))})]}),he?ge.length===0?(0,$.jsxs)(`p`,{className:`shell-muted`,"data-testid":`campus-no-matches`,children:[`No rooms on this floor match`,T?` the “only free” filter`:``,C.trim()?` “${C.trim()}”`:``,`.`]}):(0,$.jsx)(`div`,{className:`campus-room-list`,"data-testid":`campus-room-list`,children:ge.map(e=>(0,$.jsxs)(`div`,{className:`campus-zone`,children:[(0,$.jsxs)(`h2`,{className:`campus-zone-title`,children:[`Zone `,e.zone]}),(0,$.jsx)(`div`,{className:`campus-zone-rooms`,children:e.rooms.map(e=>{let t=I.get(e.code);return(0,$.jsxs)(`button`,{type:`button`,className:e.code===_?`campus-room-btn campus-room-btn--selected`:`campus-room-btn`,onClick:()=>ce(e.code),children:[(0,$.jsx)(`i`,{className:t===`free`?`campus-dot campus-dot--free`:t===`busy`?`campus-dot campus-dot--busy`:`campus-dot`,"aria-hidden":`true`}),e.code,(0,$.jsxs)(`span`,{className:`campus-room-sr`,children:[` `,`— `,f(e.kind),`,`,` `,t===`busy`?`in class now`:t===`free`?`free now`:`status unknown`]})]},e.code)})})]},e.zone))}):(0,$.jsx)(`p`,{className:`shell-muted`,"data-testid":`campus-floor-hint`,children:`Select a floor to list its rooms.`}),F.otherVenues.length>0&&(0,$.jsxs)(`details`,{className:`campus-other`,children:[(0,$.jsxs)(`summary`,{children:[`Other venues (`,F.otherVenues.length,`)`]}),(0,$.jsxs)(`p`,{className:`shell-muted`,children:[`These appear in the schedule but are outside the tower's room-code system:`,` `,F.otherVenues.join(`, `)]})]})]}):(0,$.jsxs)(`div`,{className:`campus-error`,"data-testid":`campus-error`,children:[(0,$.jsx)(`p`,{children:r}),(0,$.jsx)(`button`,{type:`button`,className:`shell-btn`,onClick:()=>ae(!0),children:`Retry`})]})]})}var md=i([{path:`*`,Component:pd}]),hd=document.getElementById(`root`);hd&&(0,h.createRoot)(hd).render((0,$.jsx)(m.StrictMode,{children:(0,$.jsx)(e,{router:md})}));